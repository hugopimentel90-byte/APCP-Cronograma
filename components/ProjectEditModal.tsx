...
const ProjectEditModal: React.FC<ProjectEditModalProps> = ({ isOpen, onClose, project, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border-t-4 border-blue-600">
        <div className="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
          <h2 className="text-xl font-bold text-gray-800">Editar Detalhes do Projeto</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <textarea
              className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all h-24 resize-none"
              placeholder="Descreva os objetivos e contexto do projeto..."
          ...
          <div>
            ...
            >
              <option value={ProjectStatus.PLANNED}>Planejado</option>
              <option value={ProjectStatus.IN_PROGRESS}>Em Execução</option>
